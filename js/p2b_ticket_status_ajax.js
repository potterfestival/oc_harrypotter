...
function UpdatePlace2bookEventStatus(event, xhr, settings)
{
    ...
    $.each(Place2BookEvents,function(index,val){
        $(val.parentNode.parentNode).append("<div class='p2b_preloader'><a href='https://place2book.com/da/14540/list/EM3892'>Bestil billet(ter)</a><i class='fa fa-cog fa-spin fa-2x fa-fw'></i><div>");
